...
#define M_INC(Reg)                                                                                                     \
  ++Reg;                                                                                                               \
  R.AF.B.l = (R.AF.B.l & C_FLAG) | ZSTable[Reg] | ((Reg == 0x80) ? V_FLAG : 0) | ((Reg & 0x0F) ? 0 : H_FLAG)

#define M_DEC(Reg)                                                                                                     \
  R.AF.B.l = (R.AF.B.l & C_FLAG) | N_FLAG | ((Reg == 0x80) ? V_FLAG : 0) | ((Reg & 0x0F) ? 0 : H_FLAG);                \
...
#define M_ADD(Reg)                                                                                                     \
  {                                                                                                                    \
    int q;                                                                                                             \
    q = R.AF.B.h + Reg;                                                                                                \
    R.AF.B.l = ZSTable[q & 255] | ((q & 256) >> 8) | ((R.AF.B.h ^ q ^ Reg) & H_FLAG) |                                 \
...
#define M_SUB(Reg)                                                                                                     \
  {                                                                                                                    \
    int q;                                                                                                             \
    q = R.AF.B.h - Reg;                                                                                                \
    R.AF.B.l = ZSTable[q & 255] | ((q & 256) >> 8) | N_FLAG | ((R.AF.B.h ^ q ^ Reg) & H_FLAG) |                        \
...
#define M_ADDW(Reg1, Reg2)                                                                                             \
  {                                                                                                                    \
    ...
    q = R.Reg1.D + R.Reg2.D;                                                                                           \
    R.AF.B.l =                                                                                                         \
        (R.AF.B.l & (S_FLAG | Z_FLAG | V_FLAG)) | (((R.Reg1.D ^ q ^ R.Reg2.D) & 0x1000) >> 8) | ((q >> 16) & 1);       \
    R.Reg1.W.l = q;                                                                                                    \
  }
...
#define M_ADCW(Reg)                                                                                                    \
  {                                                                                                                    \
    ...
    R.AF.B.l = (((R.HL.D ^ q ^ R.Reg.D) & 0x1000) >> 8) | ((q >> 16) & 1) | ((q & 0x8000) >> 8) |                      \
               ((q & 65535) ? 0 : Z_FLAG) | (((R.Reg.D ^ R.HL.D ^ 0x8000) & (R.Reg.D ^ q) & 0x8000) >> 13);            \
    R.HL.W.l = q;                                                                                                      \
  }
...
#define M_SBCW(Reg)                                                                                                    \
  {                                                                                                                    \
    ...
    q = R.HL.D - R.Reg.D - (R.AF.D & 1);                                                                               \
    R.AF.B.l = (((R.HL.D ^ q ^ R.Reg.D) & 0x1000) >> 8) | ((q >> 16) & 1) | ((q & 0x8000) >> 8) |                      \
               ((q & 65535) ? 0 : Z_FLAG) | (((R.Reg.D ^ R.HL.D) & (R.Reg.D ^ q) & 0x8000) >> 13) | N_FLAG;            \
    R.HL.W.l = q;                                                                                                      \
  }
